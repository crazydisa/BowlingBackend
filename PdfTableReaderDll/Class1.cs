...
//            try
//            {
//                // Проверяем, что поток поддерживает чтение
...
//                finally
//                {
//                    // Восстанавливаем оригинальную позицию потока
//                    if (pdfStream.CanSeek)
...
//    //        var wordsOrdered = dataWords
//    //.OrderBy(w => Math.Round(w.BoundingBox.Top + w.BoundingBox.Height / 2, 1)) // Группировка строк
